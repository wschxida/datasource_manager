...
def insert_data_to_datasource(config_center, config_datasource, start_id, end_id):
    ...
    insert_column = f"insert ignore into detail_refpage_url(Article_Detail_ID,RefPage_URL_ID,Extracted_Time) values{values};"
    # print(insert_column)
...
def main():
    ...
    select_min_id = """
                    ...
                    where Extracted_Time>DATE_SUB(CURRENT_DATE(),INTERVAL 7 day) 
