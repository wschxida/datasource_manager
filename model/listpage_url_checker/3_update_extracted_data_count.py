...
def main():
    ...
    # initialization_extracted_data_count = """update listpage_url set extracted_data_count=null;"""
    ...
    select_extracted_data_count = """
                    select RefPage_URL_ID,count(1) as count from detail_refpage_url GROUP BY RefPage_URL_ID;
                    """
    ...
    update_sql_pattern = """
                UPDATE listpage_url_check SET extracted_data_count = CASE listpage_url_id 
                {}
                END 
