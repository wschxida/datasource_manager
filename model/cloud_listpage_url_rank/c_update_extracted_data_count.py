...
def main():
    ...
    initialization_extracted_data_count = """update Cloud_Listpage_URL_rank set extracted_data_count=null;"""
    ...
    update_sql_pattern = """
                UPDATE cloud_listpage_url_rank SET extracted_data_count = CASE cloud_listpage_url_ID 
                {}
                END 
                WHERE cloud_listpage_url_ID IN {};
                """
